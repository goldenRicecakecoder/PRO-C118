$(document).ready(function() {
    ...
    $('#date-display').text('Date : ' + current_date); // Assuming an element with id 'date-display'
    ...
    function ajax_request(api_url, input_data) {
        ...
        $.ajax({
            ...
            // type of request
            type: 'POST', // Assuming POST is the type of the request
    ...
    $('#c_button').click(function() { // Assuming an element with id 'c_button'
        review = $('#c_textbox').val(); // Assuming an element with id 'c_textbox'
        input_data = { 'customer_review': review };
        ajax_request('/predict', input_data);
    ...
    $('#h_button').click(function() { // Assuming an element with id 'h_button'
        review = $('#h_textbox').val(); // Assuming an element with id 'h_textbox'
        input_data = { 'customer_review': review };
        ajax_request('/predict', input_data);
        product = 'Headphones';
    });
    ...
    $('#v_button').click(function() { // Assuming an element with id 'v_button'
        review = $('#v_textbox').val(); // Assuming an element with id 'v_textbox'
        input_data = { 'customer_review': review };
        ajax_request('/predict', input_data);
        product = 'Video Games';
    });
    ...
    $('#save_button').click(function() { // Assuming an element with id 'save_button'
        ...
        $.ajax({
            type: 'POST',
            url: '/save', // Assuming the endpoint is '/save'
            data: JSON.stringify(input_data),
            dataType: 'json',
            contentType: 'application/json',
            success: function(result) {
